...
if os.path.exists(folder_path) and os.path.isdir(folder_path):
  dirs = os.listdir(folder_path+"/weather")
else:
  os.mkdir(folder_path)
  os.mkdir(folder_path+'/weather')
        ...
        for d in range(days_per_month[m]):
            ...
            for time in times:
                if "{}_{}_{}_{}.csv".format(t_y,t_m,t_d,time) in dirs:
                    continue
                addr = "https://classic.avalanche.state.co.us/caic/obs_stns/zones.php?date={}-{}-{}+{}&stnlink=hourly&unit=e&flag=on&area=caic&span=6".format(t_y,t_m,t_d,time)
                ...
                data.to_csv("WeatherStations/weather/{}_{}_{}_{}.csv".format(t_y,t_m,t_d,time),index=False)
                data = []
