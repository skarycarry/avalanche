...
myfile = open("inputs/sites.txt", "r")
...
for s in sites:
    myfile = open("inputs/DangerSites/{}.txt".format(s), "r")
...
print(os.getcwd())
folder_path = os.getcwd()+'/AviDanger'
if os.path.exists(folder_path) and os.path.isdir(folder_path):
  files = os.listdir(folder_path) + os.listdir(folder_path+"/no")
else:
  os.mkdir(folder_path)
  os.mkdir(folder_path+'/no')
  files = []
...
for i in range(85000,125000):
    ...
    try:
        ...
        with open("AviDanger/no/{}.json".format(i),"w") as f:
            json.dump(dic, f)
        continue
    ...
    with open("AviDanger/{}.json".format(i),"w") as f:
        json.dump(jsn, f)
